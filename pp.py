...
def pp(ccx, amount="1.00", retry_count=1):
    ...
    try:
        ...
        response = r.get('https://godencounters.com/donations/treasures-from-gem-donation/', headers=headers, timeout=20)
        ...
        headers = {
            ...
            'origin': 'https://godencounters.com',
            'referer': 'https://godencounters.com/donations/treasures-from-gem-donation/',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-platform': '"Android"',
        ...
        data = {
            ...
            'give-current-url': 'https://godencounters.com/donations/treasures-from-gem-donation/',
            'give-form-url': 'https://godencounters.com/donations/treasures-from-gem-donation/',
        ...
        response = r.post('https://godencounters.com/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data, timeout=20)
        ...
        multipart_data = MultipartEncoder({
            ...
            'give-current-url': (None, 'https://godencounters.com/donations/treasures-from-gem-donation/'),
            'give-form-url': (None, 'https://godencounters.com/donations/treasures-from-gem-donation/'),
        ...
        response = r.post(
            'https://godencounters.com/wp-admin/admin-ajax.php',
            params=params,
            headers=headers,
            data=multipart_data,
            timeout=20,
