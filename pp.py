...
def pp(ccx, amount="5.00", retry_count=1):
    ...
    try:
        ...
        headers = {
            'authority': 'kenyachildrenofhope.org',
        ...
        response = r.get('https://kenyachildrenofhope.org/donations/help-children-rise-out-of-poverty', headers=headers, timeout=20)
        ...
        headers = {
            ...
            'origin': 'https://kenyachildrenofhope.org',
            'referer': 'https://kenyachildrenofhope.org/donations/help-children-rise-out-of-poverty',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-platform': '"Android"',
        ...
        data = {
            ...
            'give-current-url': 'https://kenyachildrenofhope.org/donations/help-children-rise-out-of-poverty',
            'give-form-url': 'https://kenyachildrenofhope.org/donations/help-children-rise-out-of-poverty',
        ...
        response = r.post('https://kenyachildrenofhope.org/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data, timeout=20)
        ...
        multipart_data = MultipartEncoder({
            ...
            'give-current-url': (None, 'https://kenyachildrenofhope.org/donations/help-children-rise-out-of-poverty'),
            'give-form-url': (None, 'https://kenyachildrenofhope.org/donations/help-children-rise-out-of-poverty'),
        ...
        response = r.post(
            'https://kenyachildrenofhope.org/wp-admin/admin-ajax.php',
            params=params,
            headers=headers,
            data=multipart_data,
            timeout=20,
